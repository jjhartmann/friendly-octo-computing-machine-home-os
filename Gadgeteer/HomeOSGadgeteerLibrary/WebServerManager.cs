    ...
    internal class WebServerManager
    {
        ...
        public static WebServerManager GetInstance()
        {
            if (serverManager == null)
            {
                ...
                serverManager.DefaultEvent.ResponseData = Encoding.UTF8.GetBytes("<html><head></head><body><h1>Hey, it works:-)</h1><p>Your .NET Gadgeteer Web Server is up and running!</p></body></html>");
