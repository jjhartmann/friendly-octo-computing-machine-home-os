...
{
    public class DataDirStream<KeyType, ValType> : DataFileStream<KeyType, StrValue>, IStream, IDisposable
    {

        public DataDirStream(FqStreamID FQSID, StreamFactory.StreamOp Op, CallerInfo Ci, ISync sync)
