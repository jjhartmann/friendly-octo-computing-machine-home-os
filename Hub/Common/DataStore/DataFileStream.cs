...
namespace HomeOS.Hub.Common.DataStore
{
    ...
    public class DataFileStream<KeyType, ValType> : IStream, IDisposable
    {
        ...
        public DataFileStream(FqStreamID FQSID, StreamFactory.StreamOp Op, CallerInfo Ci, ISync sync) 
        {
