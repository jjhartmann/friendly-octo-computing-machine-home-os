...
namespace HomeOS.Hub.Common.DataStore
{
    ...
    public class MetaData
    {
        ...
        public MetaData(string target_dir, string filename)
        {
        ...
        public void LoadMetaData()
        {
            try
            {
                ...
                DataContractJsonSerializer ser = new DataContractJsonSerializer(typeof(MetaData));
                MetaData md = (MetaData)ser.ReadObject(ms);
                ms.Close();
