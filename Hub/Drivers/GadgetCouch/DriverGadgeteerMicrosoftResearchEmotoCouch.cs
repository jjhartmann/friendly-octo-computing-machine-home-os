...
namespace HomeOS.Hub.Drivers.Gadgeteer.MicrosoftResearch.EmotoCouch
{
    ...
    public class DriverGadgeteerMicrosoftResearchEmotoCouch : ModuleBase
    {
        ...
        public override void Start()
        {
            ...
            List<VRole> roles = new List<VRole>() {RoleCouch.Instance};
        ...
        private List<VParamType> OnOperationInvoke(string roleName, String opName, IList<VParamType> args)
        {
